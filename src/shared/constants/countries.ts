export interface Country {
    iso2: string // uppercase 2-letter ISO code, e.g. "BD"
    name: string // English country name, e.g. "Bangladesh"
    dialCode: string // international dialing code WITH leading +, e.g. "+880"
}
